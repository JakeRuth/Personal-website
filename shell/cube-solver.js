...
(function () {
  ...
  // applyCycle: [a,b,c,d] means arr[b] := old arr[a], arr[c] := old arr[b], etc.
  ...
  // ---------- Scramble ----------
  // Avoid: same face twice in a row, and commuting-face sandwich (X Y X
  // where Y and X commute because Y is on the opposite axis).
  ...
  // ---------- Solver: bidirectional BFS ----------
  const ALL_MOVES = ['U',"U'",'R',"R'",'F',"F'",'D',"D'",'L',"L'",'B',"B'"];

  // Compact hash. Each piece is one char (cp 0-7, ep 0-11 base36), co 0-2, eo 0-1.
  ...
  // ================================================================
  // Facelet-level cube (for rendering). 54 stickers, 6 faces U R F D L B.
  // ================================================================
  ...
  // Facelets to cubie state (for solver).
