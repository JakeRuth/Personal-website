/* ================================================================
   transition-cube-v3 — 3x3 solver
   ================================================================

   Ported VERBATIM from transition-cube-v2/cube-solver.js. Only the
   exposed global name changes (TransitionCubeV2Solver →
   TransitionCubeV3Solver). The solver logic is correct in v2 and
   there's no reason to touch it for the v3 animation tune-up.

   Exposed on window.TransitionCubeV3Solver:
