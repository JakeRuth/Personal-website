/* ================================================================
   transition-cube-v4 — 3x3 solver
   ================================================================

   Ported VERBATIM from transition-cube-v3/cube-solver.js. Only the
   exposed global name changes (TransitionCubeV3Solver →
   TransitionCubeV4Solver). The solver logic is correct in v2/v3 and
   there's no reason to touch it for the v4 grow/shrink animation.

   Exposed on window.TransitionCubeV4Solver:
