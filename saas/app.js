...
(function architecture() {
  ...
  const NODES = [
    ...
    { id: "ai",       label: "AI Co-pilot",     class: "ai",      slo: "99.50%", since: "2022", blurb: "My AI philosophy: \"I drive AI. It doesn't drive me.\" (yes, like a car). Tool progression: Copilot (cool, not life-changing) → Cursor (~1–2 years heavy) → Claude Code dabble through 2025 → Opus 4.5 in early 2026 was the tidal-wave inflection. Now on Opus 4.7. Heavy Claude Code + Codex + CMUX. Built my own harness via OpenHands." },
